...
REST_FRAMEWORK = {
    "EXCEPTION_HANDLER": "config.api.exception_handler.exception_handler",
    "DEFAULT_SCHEMA_CLASS": "drf_spectacular.openapi.AutoSchema",
}

SPECTACULAR_SETTINGS = {
    "TITLE": "JetLend Orders API",
    "DESCRIPTION": (
        "Создание заказа с необязательным процентным промокодом. "
        "Цены, категории и признак исключения из акций берутся из базы данных, "
        "клиент передаёт только идентификаторы и количество."
    ),
    "VERSION": "1.0.0",
